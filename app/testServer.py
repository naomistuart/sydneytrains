...
class Train(object):
	def __init__(self, latpos, longpos, route):
		self.latpos = latpos
		...
		if self.path=="/trains":
			...
			for entity in feed.entity:
				if entity.vehicle.trip.route_id != "":
					trains.append(Train(entity.vehicle.position.latitude, entity.vehicle.position.longitude, route_lookup[entity.vehicle.trip.route_id]))
